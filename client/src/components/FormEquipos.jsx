const FormEquipos = ({ equipos, setEquipos, sendSync, onStart, setShowNameModal }) => {
   const onChange1 = (e) => {
   ...
   return (
      <form className="fixed inset-0 bg-black/85 flex items-center justify-center z-50 p-4 backdrop-blur-sm"
         onSubmit={(e) => { e.preventDefault(); if (equipos[1].nombre && equipos[2].nombre) { onStart?.(); setShowNameModal(false); } }}>
